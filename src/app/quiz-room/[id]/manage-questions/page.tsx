...
export default function ManageQuestionsPage() {
  ...
  const handleViewQuestion = (questionOrder: number) => {
    router.push(`/quiz-room/${roomId}/questions/${questionOrder}`);
  };
  ...
  const handleUpdateQuestion = (questionOrder: number) => {
    ...
    router.push(`/quiz-room/${roomId}/questions/update/${questionOrder}`);
  };
  ...
  const handleDeleteQuestion = async (questionOrder: number) => {
    ...
    if (window.confirm('Are you sure you want to delete this question?')) {
        try {
            const res = await fetch(`/api/quiz-room/${roomId}/questions/${questionOrder}`, {
                method: 'DELETE',
            });
            if (res.ok) {
                fetchQuestions();
          ...
          <div className="p-4 space-y-4 max-h-[70vh] overflow-y-auto">
            {questions.length > 0 ? (
              ...
              <div className="py-16 text-center">
                ...
                <p className="text-gray-400 font-medium text-lg mb-2">No questions in this quiz room yet.</p>
